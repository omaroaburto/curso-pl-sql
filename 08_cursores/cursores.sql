...
INSERT INTO G8_TEMPORADA(COD_TEMP, NOMBRE_TEMP, MES_INICIO, MES_FIN) VALUES(1,'OTOÑO','20-03-2021', '21-06-2021');
...
END;
--2. IMPRIMA POR PANTALLA EL NOMBRE DE CADA CATEGORÍA Y LA RENTABILIDAD DE VENTA(PRECIO DE VENTA- PRECIO DE COMPRA)
--QUE OBTENDRÍA AL VENDER TODOS LOS PRODUCTOS. ADEMÁS, INDIQUE CUÁL ES LA CATEGORIA QUE TIENE MÁS INGRESOS.

--3. MUESTRE POR PANTALLA EL VALOR TOTAL DE DESCUENTO APLICADO A UN DETERMINADO RUT INGRESADO POR TECLADO

--4. SE REALIZA UNA CLASIFICACIÓN DE CLIENTES, CONSIDERANDO QUE SI EL CLIENTE HA REALIZADO MÁS DE 3 COMPRAS SERÁ
--CONSIDERADO COMO CLIENTE PREFERENCIAL Y DE LO CONTRARIO REGULAR. POR LO QUE ES NECESARIO QUE IMPRIMA EL NOMBRE DE CADA
--CLIENTE Y LA CLASIFICACIÓN ASIGNADA. ADEMÁS, DE UN RESUMEN DE LA CANTIDAD DE CLIENTES PREFERENCIALES Y REGULARES.
